...
public class Driver extends JFrame{
	...
	Driver() {
		...
		final JComboBox<String> paddleColorComboBox = new JComboBox<>(project_types);
		paddleColorComboBox.setBounds(470, 17, 100, 30);
		panel.add(paddleColorComboBox);

		JLabel paddleLabel = new JLabel();
		paddleLabel.setText("Project Name");
		paddleLabel.setFont(new java.awt.Font("Times New Roman", Font.BOLD, 12));
		paddleLabel.setBounds(50, 50, 80, 28);
		panel.add(paddleLabel);
		
		final JTextField user = new JTextField(20);
		user.setBounds(50, 80, 250, 25);
		panel.add(user);
				
		final JLabel ballLabel = new JLabel();
		ballLabel.setText("Project Path: " +  chooser.getCurrentDirectory());
		ballLabel.setFont(new java.awt.Font("Times New Roman", Font.BOLD, 12));;
		ballLabel.setBounds(80, 120, 600, 28);
		panel.add(ballLabel);
		...
		JButton startButton = new JButton("<html><font color=black size=4><b>Create</b></html>");
		startButton.setBounds(275, 180, 90, 30);
		panel.setLayout(null);
		...
		path.addActionListener(new ActionListener() {
			 public void actionPerformed(ActionEvent e) {
			    ...
			    if (chooser.showOpenDialog(panel) == JFileChooser.APPROVE_OPTION) { 
			      ballLabel.setText("Project Path: " +  chooser.getSelectedFile());
			    }
			    else {
